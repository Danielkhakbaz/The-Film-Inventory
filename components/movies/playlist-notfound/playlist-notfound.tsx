...
const Title = dynamic(
  () => import("components/movies/playlist-notfound/components/title/title"),
  {
    ssr: false,
  }
);
const ButtonLinks = dynamic(
  () =>
    import(
      "components/movies/playlist-notfound/components/button-links/button-links"
    ),
  {
    ssr: false,
  }
